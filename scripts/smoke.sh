#!/usr/bin/env bash
set -euo pipefail
python data_pipe.py --symbols 0700.HK --recent_pages 1 --estimate_only
python data_pipe.py --symbols 0700.HK --recent_pages 1 --token_cap 50 --debug --logfile logs/smoke.log
python - <<'PY'
